...
module "lambda_ecr_repos" {
  source       = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\lambda_ecr_repos"
  region       = var.region
...
module "iam" {
  source                       = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\iam"
  region                       = var.region
  account_id                   = var.account_id
...
module "network" {
  source       = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\network"
  region       = var.region
  default_tags = var.default_tags
}

module "eks_phase_1" {
  source                       = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\eks_phase_1"
  account_id                   = var.account_id
  region                       = var.region
  default_tags                 = var.default_tags
  iam_permissions_boundary_arn = var.iam_permissions_boundary_arn
...
module "bastion" {
  source                        = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\bastion"
  region                        = var.region
...
module "kms" {
  source               = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\kms"
  region               = var.region
  default_tags         = var.default_tags
...
module "s3" {
  source              = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\s3"
  account_id          = var.account_id
  region              = var.region
  default_tags        = var.default_tags
...
module "sns" {
  source       = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\sns"
  region       = var.region
  default_tags = var.default_tags
}

module "acm" {
  source         = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\acm"
  region         = var.region
  default_tags   = var.default_tags
...
module "cron_helper" {
  source     = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\cron_helper"
...
module "sql" {
  source                           = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\sql"
  region                           = var.region
  account_id                       = var.account_id
  default_tags                     = var.default_tags
...
module "elasticache" {
  source                = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\elasticache"
...
module "deploy_build" {
  source                 = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\deploy_build"
...
module "upgrade_opensearch_nodepool" {
  source                          = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\upgrade_opensearch_nodepool"
...
module "expunge_deleted_opensearch_docs" {
  source                          = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\expunge_deleted_opensearch_docs"
...
module "ingress_logs_processor" {
  source                          = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\ingress_logs_processor"
  region                          = var.region
...
module "s3_exporter" {
  source                       = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\s3_exporter"
  region                       = var.region
...
module "probe_initiator" {
  source                          = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\probe_initiator"
...
module "flink_direct_memory_oom_detection" {
  source                           = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\flink_direct_memory_oom_detection"
  region                           = var.region
  account_id                       = var.account_id
...
module "cloudwatch_metrics_exporter_phase_1" {
  source                                             = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\cloudwatch_metrics_exporter_phase_1"
  region                                             = var.region
  default_tags                                       = var.default_tags
  iam_permissions_boundary_arn                       = var.iam_permissions_boundary_arn
...
module "git_crawler" {
  source                          = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\git_crawler"
  region                          = var.region
...
module "waf" {
  source                           = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\waf"
  region                           = var.region
  default_tags                     = var.default_tags
...
module "proxy" {
  ...
  source                       = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\modules\proxy"
  account_id                   = var.account_id
  region                       = var.region
  iam_permissions_boundary_arn = var.iam_permissions_boundary_arn
...
module "k8s" {
  source              = "C:\Users\blueg\OneDrive\Documents\Aflac\Glean\Terraform\terraform_aws_full_deploy\glean.com\aws\modules\..\k8s\full_deploy"
